...
[![Build Status](https://travis-ci.org/VictorUkafor/WEConnect.svg?branch=(011-template-server_create-login-api)](https://travis-ci.org/VictorUkafor/WEConnect) [![Coverage Status](https://coveralls.io/repos/github/VictorUkafor/WEConnect/badge.svg?branch=011-template-server_create-login-api)](https://coveralls.io/github/VictorUkafor/WEConnect?branch=(011-template-server_create-login-api)
